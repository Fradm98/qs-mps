...
for chi in args.chis:  # L // 2 + 1
    ...
    np.savetxt(
        f"/Users/fradm98/Google Drive/My Drive/projects/0_ISING/results/bond_data/middle_chain_schmidt_values_{args.model}_L_{args.L}_flip_{args.flip}_delta_{delta}_chi_{chi}",
        schmidt_values,
    )
