...
np.savetxt(
    f"/data/fdimarca/projects/0_ISING/results/exact/entropy/exact_entropy_tot_{args.model}_L_{args.L}_flip_{args.flip}_h_ev_{args.h_ev}_trotter_steps_{args.trotter_steps}_t_{args.time}",
    entropy_tot,
)