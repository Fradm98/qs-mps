...
"""
if flip:
    file_path = f"/data/fdimarca/projects/0_ISING/results/maricarmen_results/mps_L15_Z0_flip_g0_3_D20.txt"
    mag_tot_maricarmen = [L - 2]
    mag_loc_Z_maricarmen = [-1]

else:
    file_path = f"/data/fdimarca/projects/0_ISING/results/maricarmen_results/results_L15_Z0_g0_3.txt"
...
file_path_tot = f"/data/fdimarca/projects/0_ISING/results/exact/mag_data/mag_exact_tot_{model}_L_{L}_flip_{flip}_h_ev_{h_ev}_trotter_steps_{trotter_steps_j}_t_{t}"
file_path_loc = f"/data/fdimarca/projects/0_ISING/results/exact/mag_data/mag_exact_loc_{model}_L_{L}_flip_{flip}_h_ev_{h_ev}_trotter_steps_{trotter_steps_j}_t_{t}"
file_path_loc_Z = f"/data/fdimarca/projects/0_ISING/results/exact/mag_data/mag_exact_loc_Z_{model}_L_{L}_flip_{flip}_h_ev_{h_ev}_trotter_steps_{trotter_steps_j}_t_{t}"
file_path_loc_X = f"/data/fdimarca/projects/0_ISING/results/exact/mag_data/mag_exact_loc_X_{model}_L_{L}_flip_{flip}_h_ev_{h_ev}_trotter_steps_{trotter_steps_j}_t_{t}"
file_path_entr = f"/data/fdimarca/projects/0_ISING/results/exact/entropy/exact_entropy_{where}_{model}_L_{L}_flip_{flip}_h_ev_{h_ev}_trotter_steps_{trotter_steps_j}_t_{t}"
